...
export const resultsShowcase = {
  ...
  shots: [
    ...
    },
    {
      ...
      caption: {
        ar: 'Shopify · 7–17 سبتمبر 2026',
        en: 'Shopify · Sep 7–17, 2026',
      },
      alt: {
        ar: 'داشبورد Shopify لستور Veloura: 28.3K جلسة، إجمالي مبيعات EGP 1,061,525، 1,361 أوردر، ومعدل تحويل 4.51%.',
        en: "Veloura’s Shopify dashboard: 28.3K sessions, EGP 1,061,525 total sales, 1,361 orders and a 4.51% conversion rate.",
      },
      span: 7,
    },
    {
